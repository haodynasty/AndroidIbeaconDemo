...
public class BeaconManager {
     ...
     * @see #setLogLevel(LogManager.LogLevel)
     * @param debug True turn on all logs for this library to be printed out to logcat. False turns
     *              off all logging.
     * @param debug True turn on all logs for this library to be printed out to logcat. False turns
     *              off all logging(but print error). if you want show log by yourself ,you can use
     *              {@link org.altbeacon.beacon.logging.LogManager#setLogLevel(LogManager.LogLevel)}
     */
    public static void setDebug(boolean debug) {
        if (debug){
            LogManager.setLogLevel(LogManager.LogLevel.VERBOSE);
            LogManager.setVerboseLoggingEnabled(true);
        }else {
            LogManager.setLogLevel(LogManager.LogLevel.NONE);
            LogManager.setVerboseLoggingEnabled(false);
        }
    }

    /**
     * set log print level, if set LogLevel.NONE will not print any log
     * @param logLevel
     */
    public static void setLogLevel(LogManager.LogLevel logLevel){
   ...
   protected BeaconManager(Context context) {
      ...
      this.beaconParsers.add(new IbeaconParser());//AltBeaconParser
   }
